...
class SkosConceptSchemeForm(forms.ModelForm):
    class Meta:
        ...
        widgets = {
            "curator": autocomplete.ModelSelect2Multiple(url="vocabs-ac:user-autocomplete"),
        }
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.helper.layout = Layout(
            Div(
                ...
                Fieldset("Add description", Formset("descriptions"), css_class="formset-div"),
                Field(
                    "identifier",
...
class CollectionLabelForm(forms.ModelForm):
    name = forms.CharField(
        ...
        error_messages=custom_name_errors(field_name=CollectionLabel._meta.get_field("name").verbose_name),
    )
    language = forms.CharField(
        required=False,
        label=CollectionLabel._meta.get_field("language").verbose_name,
        help_text=CollectionLabel._meta.get_field("language").help_text,
        error_messages=custom_lang_errors(field_name=CollectionLabel._meta.get_field("name").verbose_name),
    )
...
class CollectionNoteForm(forms.ModelForm):
    name = forms.CharField(
        ...
        error_messages=custom_name_errors(field_name=CollectionNote._meta.get_field("name").verbose_name),
        widget=forms.Textarea,
    )
    language = forms.CharField(
        required=False,
        ...
        error_messages=custom_lang_errors(field_name=CollectionNote._meta.get_field("name").verbose_name),
    )
...
class CollectionSourceForm(forms.ModelForm):
    name = forms.CharField(
        ...
        error_messages=custom_name_errors(field_name=CollectionSource._meta.get_field("name").verbose_name),
        widget=forms.Textarea,
    )
    language = forms.CharField(
        required=False,
        ...
        error_messages=custom_lang_errors(field_name=CollectionSource._meta.get_field("name").verbose_name),
    )
...
class SkosCollectionForm(forms.ModelForm):
    class Meta:
        ...
        widgets = {
            "scheme": autocomplete.ModelSelect2(url="vocabs-ac:skosconceptscheme-autocomplete"),
        }
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.helper.layout = Layout(
            Div(
                ...
                Field("contributor"),
                Field("legacy_id"),
                Fieldset("Add documentary note", Formset("notes"), css_class="formset-div"),
                Fieldset(
                    "Add source information",
                    Formset("sources"),
                    css_class="formset-div",
...
class ConceptLabelForm(forms.ModelForm):
    name = forms.CharField(
        ...
        error_messages=custom_name_errors(field_name=ConceptLabel._meta.get_field("name").verbose_name),
    )
    language = forms.CharField(
        required=False,
        label=ConceptLabel._meta.get_field("language").verbose_name,
        help_text=ConceptLabel._meta.get_field("language").help_text,
        error_messages=custom_lang_errors(field_name=ConceptLabel._meta.get_field("name").verbose_name),
    )
...
class ConceptNoteForm(forms.ModelForm):
    name = forms.CharField(
        ...
        error_messages=custom_name_errors(field_name=ConceptNote._meta.get_field("name").verbose_name),
        widget=forms.Textarea,
    )
    language = forms.CharField(
        required=False,
        ...
        error_messages=custom_lang_errors(field_name=ConceptNote._meta.get_field("name").verbose_name),
    )
...
class ConceptSourceForm(forms.ModelForm):
    name = forms.CharField(
        ...
        error_messages=custom_name_errors(field_name=ConceptSource._meta.get_field("name").verbose_name),
        widget=forms.Textarea,
    )
    language = forms.CharField(
        required=False,
        ...
        error_messages=custom_lang_errors(field_name=ConceptSource._meta.get_field("name").verbose_name),
    )
...
class SkosConceptForm(forms.ModelForm):
    broader_concept = TreeNodeChoiceField(
        ...
        widget=autocomplete.ModelSelect2(url="vocabs-ac:skosconcept-autocomplete", forward=["scheme"]),
    ...
    collection = forms.ModelMultipleChoiceField(
        ...
        widget=autocomplete.ModelSelect2Multiple(url="vocabs-ac:skoscollection-autocomplete", forward=["scheme"]),
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.helper.layout = Layout(
            Div(
                ...
                Fieldset("Add other labels", Formset("labels"), css_class="formset-div"),
                Field("scheme"),
                # Field('top_concept'),
                Field("collection"),
