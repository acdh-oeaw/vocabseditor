...
urlpatterns = [
    ...
    path(
        "scheme/remove-keys/<int:pk>",
        views.delete_legacy_id_view,
        name="skosconceptscheme_remove_keys",
    ),
    path(
        "scheme/remove-notations/<int:pk>",
        views.delete_notation_view,
